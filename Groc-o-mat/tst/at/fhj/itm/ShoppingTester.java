...
/**
 * Unittestclass - This should show how the Classes will be used. It will be
 * changed for grading. (The principle stays the same but the data changes - so
 * i can see if the result is correct or just a good guesses).
 * 
...
public class ShoppingTester {
	...
	public void testOptimization() {
		...
		// That is for a good reason: You should learn how to implement HQL
		// Queries
		 ...
		 * 
		 * Weissbrot ... There is only one item named weissbrot: wbrot. It is
		 * 2.50@billa and 2.2@lidl => buy at lidl Extra ... The only store that
		 * offers extra is billa. It costs 1.80 => Buy at billa. Eier ... There
		 * is no item named like this, but there is a category. The category
		 * contains feier und beier. Cheapest feier: feier is neither offered in
		 * Billa nor in Lidl Cheapest beier : 1.7@lidl => Buy at Lidl 7 ...
		 * There is neither an Item with that name nor a category .. so it has
		 * to be an EAN Code. The Item with the EanCode 7 is: haltbarmilch.
		 * haltbarmilch@Billa:2.75 haltbarmilch@Lidl:2.5 => Buy at lidl
		 * 
		 * Mineral ... There is no item, category or ean code named like this =>
		 * You cannot buy it -> Feel free to list it at the end of the list in a
		 * "Unknown" store.
		 * 
		 * Therefore the correct solution is:
		 * 
		 * LIDL o Weissbrot (2.50) o BodenhaltungEier (1.70) o Haltbar Milch
		 * (2.50)
		 * 
		 * BILLA o Extra (1.80)
		 * 
		 * UNBEKANNT o Mineral (0.00) ============================== SUM 8.50
		 */

		// Be aware: I am going to change the input parameters to see if
		// everything
		// is persisted correctly and to check if the cheapest solution is
		// found.
	}
}
